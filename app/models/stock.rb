class Stock < ActiveRecord::Base
	...
	def getYahooFinanceData
		...
		data = {
			...
			historical: yahoo_client.historical_quotes(self.ticker, { start_date: Time::now-(24*60*60*365), end_date: Time::now }),
			data: yahoo_client.quotes([self.ticker], [
